...
namespace SalesWebMvc.Controllers
{
    public class SellersController : Controller
    {
        ...
        public async Task<IActionResult> Index() //chamada do conhtrolador, pegando o model e encaminhando os dados para a view
        {
        ...
        {
            var departments = await _departmentService.FindAllAsync(); //buscar no db tds os departamentos 
        ...
        public async Task<IActionResult> Create(Seller seller)
        {
            ...
            await _sellerService.InsertAsync(seller); //implementação da ação de inserir esse cara no banco de dados
