...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public SeedingService(SalesWebMvcContext context) //construtor pra indicar que a injeção de objetos deve acontecer
        {
            _context = context;
        }

        public void Seed() //operação responsável por popular o banco de dados
        {
            //If para testar se já existe algo na minha base de dados
            ...
            Department d2 = new Department(2, "Electromics");
            Department d3 = new Department(3, "Fashion");
            Department d4 = new Department(4, "Books");

            Seller s1 = new Seller(1, "Bob brow", "bob@gmail.com", new DateTime(1998, 4, 21), 1000.0, d1); //Criado vendendor e feito a associação entre os objetos
            ...
            Seller s5 = new Seller(5, "Donald Blyue", "donald@gmail.com", new DateTime(2000, 1, 9), 4000.00, d3);
            Seller s6 = new Seller(6, "Alex Pink", "bob@gmail.com", new DateTime(1997, 3, 4), 3000.00, d2);

            //criando os registros de vendas
            ...
            //Adicionando esses objetos ao Banco de Dados usando o Entities FrameWork
            _context.Department.AddRange(d1, d2, d3, d4); //o método AddRAnge permite que você adicione vários objetos de uma só vez 
